...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'MENTION', 'COMMENT', 'DUE_DATE', 'INVITATION');

-- CreateEnum
CREATE TYPE "ActivityAction" AS ENUM ('TASK_CREATED', 'TASK_UPDATED', 'TASK_STATUS_CHANGED', 'COMMENT_ADDED', 'USER_INVITED', 'FILE_UPLOADED', 'FILE_DELETED', 'PROJECT_CREATED', 'PROJECT_DELETED');
